              ...
              <div className="sm:flex sm:gap-4">
                {
                  user?.uid
                    ? (
                      <button onClick={logOutUser} className="rounded-md bg-teal-600 px-5 py-2.5 text-sm font-medium text-white shadow" to="/login">
                        Log Out
                      </button>
                    )
                    : (
                      <>
                        ...
                        <div className="hidden sm:flex">
                          <Link className="rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-teal-600" to="/signup">
                            Sign Up
                          </Link>
                        </div>
                      </>
